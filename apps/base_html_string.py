...
<body class="">
  <div class="wrapper ">
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="/ui-tables">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="/clinical_analysis">
              <i class="material-icons">library_books</i>
              <p>Clinical Analysis</p>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="/ui-icons">
              <i class="material-icons">bubble_chart</i>
              <p>Icons</p>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="/ui-maps">
              <i class="material-icons">location_ons</i>
              <p>Maps</p>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="/ui-notifications">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="/page-rtl-support">
          ...
          <li class="nav-item active-pro ">
            <a class="nav-link" href="https://appseed.us/admin-dashboards/flask-dashboard-material-design">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                  <a class="dropdown-item" href="/page-user">Profile</a>
  ...
  <!--   这里为了加dash应用footer就不要了，非dash页面保留footer   --->
  <!--   Core JS Files   -->
